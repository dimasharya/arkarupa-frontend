export default function BadgeTaskStatus({ status }) {
  ...
  if (status === "Dijadwalkan") {
    cls =
      "text-xs rounded-xl border text-orange-800 border-orange-600 py-1 px-2 bg-orange-100";
  } else if (status === "Dimulai") {
    cls =
      "text-xs rounded-xl border text-blue-800 border-blue-600 py-1 px-2 bg-blue-100";
  } else if (status === "Dijeda") {
    cls =
      "text-xs rounded-xl border text-gray-800 border-gray-600 py-1 px-2 bg-gray-100";
